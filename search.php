...
<div class="container-fluid red-background size">
	...
	<option value="">-- Select --</option><option value="All">All</option><optgroup title="Maharashtra" label="&raquo; Maharashtra"></optgroup>
						...
						<option value="Thanjavur">Thanjavur</option></select>
							</div>

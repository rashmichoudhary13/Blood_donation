	...
	if (isset($_POST['date'])) {
		...
		$showForm = '
			...
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Are you sure you want to proceed further? If you press YES, then you will not be able to be shown for the next 3 months.</strong>
				...
				<div class="panel panel-default" style="padding: 20px;">
					<div class="panel-body">
						...
						<div class="alert alert-danger alert-dismissable" style="font-size: 18px; display: none;">
							...
							<strong>Warning!</strong> Are you sure you want to save the life if you press 'yes,' then you will not be able to be shown for the next 3 months.
						...
						if ($savedate == '0') {
							...
							if ($diffMonth >= 3) {
								...
								echo '<div class="donors_data">
										...
										<span>You have already saved a life, and we are very thankful to you. You can donate blood again in three months.</span>
										</div>';
							}
						}
						?>

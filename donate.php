		...
		<div class="col-md-6 offset-md-3 form-container">
			...
			<form class="form-group" action="" method="post" novalidate="">
				...
				<div class="form-group">
					...
					<input type="password" name="password" value="" placeholder="Password" class="form-control" required pattern=".{6,}" title="Password must contain at least 6 characters.">
